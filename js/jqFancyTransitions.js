...
(function($){
    ...
    $.fn.jqFancyTransitions=$.fn.jqfancytransitions=function(options){
        init=function(el){
            ...
            $('#'+el.id).append("<div class='ft-title' id='ft-title-"+el.id+"' style=' padding:5px;position: absolute; left: 0; margintop: 220; z-index: 1; height:30px; width:940px; color: #fff; background-color: #000; '>"+titles[el.id][0]+"</div>");
